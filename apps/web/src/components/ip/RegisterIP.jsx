...
export default function RegisterIP() {
  ...
  async function handleUpload() {
    ...
    try {
      ...
      // -------- DUPLICATE DETECTION --------
      const check = await fetch("/api/check-duplicate", {
        method: "POST",
        headers: {
      ...
      if (duplicate.exists) {
        ...
        toast.error(`File already registered by ${duplicate.owner}`);
  ...
  return (
    ...
    <div className="bg-[#0b1222] border border-gray-700 rounded-xl p-8 shadow-xl space-y-6">
